...
- Alternative to installing: [RStudio Server](https://rstudio.hmcse.uwf.edu/) hosted by HMCSE](https://uwf.edu/hmcse/)
...
Show GitHub webpage with pushed stuff

## RStudio and GitHub {background-image="/Users/sseals/Library/CloudStorage/GoogleDrive-sseals@uwf.edu/My Drive/00 - Personal/R/quarto themes/slide.png" background-size="contain"} 

Show GitHub page with new stuff
